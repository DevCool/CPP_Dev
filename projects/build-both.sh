...
if [ -d "bin" ]; then
	if [[ -e bin/fileio && -e bin/opengl1 && -e bin/opengl2 && -e bin/opengl3 && -e bin/opengl4 ]]; then
	...
	if [[ -e bin/fileio.exe && -e bin/opengl1.exe && -e bin/opengl2.exe && -e bin/opengl3.exe && -e bin/opengl4.exe ]]; then
